...
let WsLoaded = false; 
const messages = [
    { message: 'Từ từ đang tải', delay: 0 },
    { message: 'Đang tải các plugins...', delay: 5000 },
    { message: 'Chờ tí sắp tải xong....', delay: 12000 },
    { message: 'Mạng lỏ nên tải chậm', delay: 20000 }
];
messages.forEach(msg => {
    ...
    const descriptions = [
        ...
        "Điện thoại là biển lớn",
        "Mạng xã hội là thuyền trôi",
        "Cuộn thả không ngừng nghỉ.",
        "Mẩn mê cả ngày trời!",
