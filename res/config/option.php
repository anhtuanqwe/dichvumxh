...
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    public $title = "Anh Tuấn | Resources V5";
    public $description = "Tuấn Developer website!";
    public $keywords = "tuan,web tuan,anhtuan,";
    public $favicon = "./res/v5/img/male1.jpg";
    public $namesite = "Tuấn | HOME";
    public $avatar = "./res/v5/img/anh2.gif";
    public $userName = ["Website demo", "Frontend", "Nhìn đại ik 🌭"];
    public $trigger = "👉 Profile 😶&zwj;🌫️";
    public $bio1 = "🤖️ Website Developer";
    public $bio2 = "🔍 10 năm nx lên Fullstack";
    public $bio3 = "💻 Kỹ sư phát triển front-end";
    public $bio4 = "Màu mè 🥳";
    public $bio5 = "=)) 🎮";
    public $bio6 = "Hết ✨";
    public $SocialNetworks = [
        "facebook" => "https://www.facebook.com/profile.php?id=61566241707057", // Thay link facebook
        "instagram" => "https://www.facebook.com/profile.php?id=61566241707057", // Thay link instagram
        "tiktok" => "https://www.tiktok.com/@anhtuanqwe", // Thay link tiktok
        "telegram" => "https://www.facebook.com/profile.php?id=61566241707057" // Thay link telegram
    ];
...
class ThanhDieuLoveDays implements ThanhDieuConfigInterface {
    public $ConfigLove = [
        ...
        "name_male" => "Anh Tuấn", // Thay tên của bạn
        //========================================================//
        ...
        "name_female" => "Tuấn", // Thay tên đối phương
        //========================================================//
        "time_relashiption" => "25/01/2010" // Định dạng ngày tháng năm: DD-MM-YYYY or / or :
        //========================================================//
    ];
    public function CommonMethod() {}
}
