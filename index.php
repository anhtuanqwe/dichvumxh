...
<head>
    ...
    <meta property="og:url" content="//anhtuan.com">
...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            <div class="medias">
                <video class="item_video" autoplay loop muted playsinline>
                    <source src="./res/v5/files/video/code.mp4" type="video/mp4">
                </video>
                <div class="date"></div>
            </div>
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="https://i.imgur.com/8ZOo37t.png" alt="Anh Tuấn">
    ...
    <main id="td-main">
        <nav id="nav" class="hide">
            <div class="td-popup" id="share_card">
                <div class="left">
                    <div class="title">Thôi Thoát Đi</div>
                    <span class="td_copy" title="Đừng nhấn">
                        <i class="ri-file-copy-line"></i>&nbsp;https://<?php echo 'anhtuanprofile.blogspot.com'; ?>?t=share
                    </span>
                ...
                <div class="right">
                    ...
                    <img class="avatar-nav"
                        src="https://chart.googleapis.com/chart?chs=96x96&cht=qr&chl=https%3A%2F%2Fanhtuanprofile.blogspot.com&choe=UTF-8"
                        alt="Qr-code">
                </div>
            </div>
        </nav>
        ...
        <section class="td-content">
            <div class="about-me">
                ...
                <div class="avatar">
                    <img class="avatar-img" src="<?=$ThanhDieuHeader->avatar?>?v=<?=rand(1,999)?>" alt="Anh Tuấn">
    ...
    <footer id="footer">
        <span>
            <a href="//thanhdieu.com" target="_blank">&copy; Copyright&nbsp;AnhTuan 2024</a>
        </span>
    </footer>
